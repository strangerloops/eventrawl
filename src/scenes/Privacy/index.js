...
class Privacy extends Component {
  ...
  render() {
    return (
      <div>
        <p>This Privacy Policy governs the manner in which Eventrawl collects, uses, maintains and discloses information collected from users (each, a "User") of the https://eventrawl.herokuapp.com website ("Site").</p>
        ...
        <p>Eventrawl may collect and use Users personal information for the following purposes:</p>
        <ul>
          <li>
        ...
        <p>Eventrawl has the discretion to update this privacy policy at any time. When we do, we will post a notification on the main page of our Site. We encourage Users to frequently check this page for any changes to stay informed about how we are helping to protect the personal information we collect. You acknowledge and agree that it is your responsibility to review this privacy policy periodically and become aware of modifications.</p>
        ...
        <p>This document was last updated on December 22, 2017</p>
      </div>
    );
  }
}
